...
static HD44780_ERROR_CODE_DEF HD44780_GetDDRamAdd (HD44780_XY_DEF X, HD44780_XY_DEF Y,Int8U * DDAdd);
static HD44780_ERROR_CODE_DEF HD44780_CheckVisual(Int8U DDRamAdd);
...
Int8U Command;
  ...
  Dly100us(HD44780_POWER_UP_DLY);
  LCD_RS_LOW();
  HD44780WrComm_High(HD44780_FUNCTION_SET+HD44780_FUNCTION_SET_8_BIT);
  Dly100us(HD44780_FIRST_COMM_DLY);
  HD44780WrComm_High(HD44780_FUNCTION_SET+HD44780_FUNCTION_SET_8_BIT);
  Dly100us(HD44780_SECOND_COMM_DLY);
  HD44780WrComm_High(HD44780_FUNCTION_SET+HD44780_FUNCTION_SET_8_BIT);
  Dly100us(HD44780_SECOND_COMM_DLY);
